...
class OpMax(OpKeepdims):
    """Calculate the maximum of elements."""
    ...
    def __init__(self,
                 ...
                 keepdims: bool = False,
                 **kwargs):
        super(OpMax, self).__init__(self.__class__, x, axis, keepdims, **kwargs)
    ...
    def _forward(self, feed_dict: Mapping[Union[str, OpPlaceholder], np.ndarray]) -> np.ndarray:
        ...
        return np.max(self.inputs[0].forward(feed_dict), axis=self.axis, keepdims=True)
